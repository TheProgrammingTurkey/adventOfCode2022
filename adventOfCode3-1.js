...
for(let i = 0; i < elves.length; i++){
  const firstHalf = elves[i].slice(0, elves[i].length / 2);
  const secondHalf = elves[i].slice(elves[i].length / 2);
  const duplicate = check(firstHalf, secondHalf)
...
function check(firstHalf, secondHalf){
